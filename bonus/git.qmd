...
![Figure modified after @allesina2019.<br>(Note that the `main` branch is here called "master".)](../img/csb-branch-intro.png){fig-align="center" width="75%"}
...
![Figure from after @allesina2019](../img/csb-branch.png){fig-align="center" width="90%"}
