...
you learned about
[globbing (selecting files) with the `*` wildcard](week03/w3a_shellfiles.html#wildcard-expansion-globbing).
While not as frequently used as the `*`,
a few other shell wildcards exist and these can occasionally be very useful too.
...
which can run with FASTQ files at once, taking each as an argument:
