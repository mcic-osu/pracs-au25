---
title: "Advanded Slurm batch jobs"
subtitle: "Optional self-study content for week 7"
pagetitle: "PRACS25: Slurm bonus"
date: 2025-09-01
author:
...
Creating makeshift pipelines by pushing the limits of the shell script and
Slurm tool set:
...
## Additional commands for job info
...
You may want to use an `sstat` call like the following
