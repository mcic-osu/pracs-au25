...
- Managing and sharing your code and data (*weeks 4 & 5*)
- Using open-source software in proper ways, e.g. with containers (*week 6*)
- Reporting a clear protocol (*week 7*) or creating an automated
  pipeline to (re)run your analyses (*weeks 9-10*)
...
- To document and report what you are doing,
  you'll use a plain-test file format called *Markdown*.

<br>

![](../img/markdown.png){fig-align="center" width="32%" fig-alt="The Markdown logo." .lightbox}
...
::::: columns
::: {.column width="35%"}
![](../img/R_logo.svg.png){fig-align="center" width="65%" fig-alt="The R logo." .lightbox}
:::
::: {.column width="35%"}
<br>
![](../img/RStudio_logo_flat.svg.png){fig-align="center" width="90%" fig-alt="The RStudio logo." .lightbox}
:::
::: {.column width="25%"}
![](../img/logo-quarto.png){fig-align="center" width="65%" fig-alt="The Quarto logo." .lightbox}
:::
:::::
...
- [Introduction to omics data](./w1_2_omics-data.qmd)
- [Introduction to the Ohio Supercomputer Center (OSC)]((./w1_3_osc.qmd))
