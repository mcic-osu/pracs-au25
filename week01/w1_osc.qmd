...
This is only meant as a brief introductory overview to give some context about
the working environment that we will start using this week.
During the course, you'll learn a lot more about most topics touched on in this page ---
week 5 in particular focuses on OSC.
...
During the course, we will be working in the project directory of the course's OSC Project `PAS2700`: `/fs/ess/PAS2700`.
(We'll talk more about these different file systems in week 5.)
