...
- The majority of my time is spent providing research assistance with omics
  data analysis
...
- All reported data, methods and results are congruent
  (e.g., the shared data + methods produce the reported results)
...
We will cover the following good practices for reproducibility:
...
This course's example data processing and analysis involves
_nucleotide sequencing-based data_ (i.e., genomics and transcriptomics),
which can often be divided into two subsequent stages:
...
Being able to work in the Unix shell is a fundamental skill for omics data,
because a lot of the specialized data processing software is operated using the shell.
...
While the Unix shell environment is the best choice for initial (algorithmic)
processing of most omics data,
R is the most prominent language in its "downstream" statistical analysis and
visualization.
...
{{< fa user-edit >}} [***Do you use generative AI on a daily basis?***]{style="color:darkgreen"}
...
This is well possible but not entirely clear either.
:::
...
- There is also a
  ...
  - Send weekly announcements about the upcoming week
...
These are assigned during the weeks in the table below, due on each following Monday,
...
|---|-------|----|:-----:|
I   | **Proposal**            | week 12 | 5
II  | **Draft**               | week 14 | 5
III | **Oral presentations**  | week 15 | 10
IV  | **Final submission**    | week 16 | 20
...
In a few of the weeks, you will be asked to read 1 or 2 papers.
Additionally:

- You are _always_ expected to reread and practice with the lecture material
  we go through in class.

- Anything on a given lecture page that we do not cover in class
...
- In particular, we'll often skip or glance over contents in "callout boxes"
  (like the one below), but you should make sure to read those in your own time.
...
please [indicate your availability](https://www.when2meet.com/?31812132-5xBVi).
