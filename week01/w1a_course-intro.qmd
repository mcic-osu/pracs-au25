...
1. **Replicability** is when independent experiments produce the same results
2. **Reproducibility** is when the same data produce the same results (_a lower bar!_)
