...
**By using code, you can also work more efficiently and improve automation** —\
this can be particularly useful when having to:
...
- Exercices (in weeks that do not have graded assignments)
