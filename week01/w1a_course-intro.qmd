...
- All reported data, methods and results are congruent
  (e.g., the shared data + methods produce the repored results)
...
- Proper project file organization  (*week 2*)
...
- These have disrupted university-level teaching and many courses,
  including this one, have not fully adapted to the (ever-changing) AI era.
...
- Most class time will be spent doing "participatory live coding",
  where I demonstrate typing and running code live and you're expected to follow
...
Try to be prepared to share your screen for troubleshooting purposes at any time.
:::

## Course websites

- The main website for this course is this "GitHub website"
  (<https://mcic-osu.github.io/pracs-au25>), which contains:
...
- The CarmenCanvas site for this course is at:
  <https://osu.instructure.com/courses/187770>.
  This site is primarily used to:
  - Send weekly announcements about the upcoming week
  - Get deadlines on the calendar for you

## Office hours

- Jelmer: Wednesday at 1-3 pm
- Menuka: TBA
...
- Many weeks have optional readings from the following two books:
...
In most weeks, any readings from books or papers are _optional_.
...
- In particular, we'll often skip or glance over contents in "callout boxes"
  (like this one!), but you should make sure to read those in your own time.
:::

## Weekly recitation on Monday

We will have an optional but highly recommended weekly recitation meeting on Mondays,
to go over the exercises for the preceding week (DETAILS TBA).
