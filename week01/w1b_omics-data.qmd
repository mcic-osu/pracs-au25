...
## Stage I of the RNA-Seq analysis

The first stage involves going from **reads to gene counts**:

TBA

## Stage I of the RNA-Seq analysis (cont.)
...
## Stage II of the RNA-Seq analysis

The second stage is the **analysis of the gene counts**.
It compares them between treatments to see e.g. which genes (and functions)
are upregulated by a certain treatment.

![](../img/geneplot.png){fig-align="center" width="55%" fig-alt="A plot comparing gene expression levels for a single gene between two treatments." .lightbox}
