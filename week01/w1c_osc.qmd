...
There will also be a [deeper dive into OSC in week 5](../week05/w5a_osc.qmd).
...
(a "compute job").
The Slurm *job scheduler*, which you will learn to use later in this course,
