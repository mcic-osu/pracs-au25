...
- **Software needs**\
  ...
  Many of the external tools that we use for this are run using the shell with
...
- **Working with large files**\
  ...
  which are very common when working with omics data.
...
- **Running external software**\
  As mentioned above,
  we need to use many external programs with a CLI when we do omics data analysis.
  While those _can_ be called from within other languages,
  the shell has a _direct_ interface to them and is therefore often strongly
  preferred.
