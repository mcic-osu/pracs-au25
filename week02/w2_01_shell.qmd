...
### Create your own dir & download some data

Our base OSC directory for the course is the **`/fs/ess/PAS2880`** dir we are currently in.
Now, you will create our own directory within here,
and download a repository with practice data from the [CSB book](https://library.ohio-state.edu/record=b8624007~S7).
