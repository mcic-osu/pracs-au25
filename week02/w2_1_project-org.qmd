...
key importance. This is not always easy!
It can be much more appealing to just keep chugging along.
In fact, in the moment, it may even seem like a waste of time to make notes on
what _then and there_ is obvious:
you will likely have a clear idea of what you did all morning.

However, you will not have such a clear idea of that a month later,
...
is that it is self-documenting to a much larger extent than is pointing and
...
"README" -- or include that phrase in their name.
...
- For **larger projects**, such as those that should produce a stand-alone
  ...
  a single README file may get a bit out of control,
  and it makes sense to split it into the following types of files.
