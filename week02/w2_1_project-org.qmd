...
- The Unix directory structure is entirely _hierarchical_,
...
<details><summary>Given that **absolute paths** do not depend on your working dir,
while **relative paths** do, and won't work if you're elsewhere --- don't absolute paths sound better? What could be a disadvantage of them?</summary>
