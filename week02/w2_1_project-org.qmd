...
::::::: columns
:::: {.column width="50%"}
![_An example showing subfolders within `results` mostly organized by the software that produced the results. Separate runs for MultiQC are grouped into further subfolders by date._](../img/proj-ex-results1_2025.png){fig-align="center" width="60%"}
::::
:::: {.column width="50%"}
![Like the example on the left, but here, separate runs for MultiQC are grouped into subfolders using a description.](../img/proj-ex-results2_2025.png){fig-align="center" width="64%"}
::::
:::::::
...
![](../img/proj-ex-annot_2025.png){fig-align="center" width="60%"}
