...
- Interactive Apps like VS Code and RStudio **run on compute nodes** (not login nodes).
  ...
  - The "_Cluster_" that we want to use: `pitzer-rhel9`
...
![_The Markdown preview icon in VS Code_](../img/markdown-preview-vscode.png){fig-align="center" width="3% fig-alt="A screenshot of the Markdown preview icon in VS Code." .lightbox}
...
In practice, I rarely manually render Markdown files because:

- Markdown source is so well readable (and you can also see rendered preview in VS Code)
...
#### Pandoc example commands _(Click to expand)_
