...
to access a Unix shell, follow the same steps as before:
...
3. In the form on the page that appears, fill out the following:
   ...
   - "_Number of hours_": `2`
   - "_Working Directory_": your personal dir in `/fs/ess/PAS2880/users` (e.g. `/fs/ess/PAS2880/users/jelmer`)
...
### Move into your own dir & download some data

- Move into your personal dir using `cd`:
