...
personal dir within `/fs/ess/PAS2880` from Thursday's class.
(If not, `cd` to `/fs/ess/PAS2880/users/$USER`,
...
## Exercise 3: Summarizing tabular files
...
## Exercise 4: Next-Generation Sequencing Data
...
## Exercise 5: Hormone Levels in Baboons
