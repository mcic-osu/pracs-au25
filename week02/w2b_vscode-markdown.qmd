...
Now, let's learn some additional Markdown syntax by typing what is shown on the left,
...
Second, leave a **space after** heading (`#`) and list (`-` or `1.`) items
...
- A **single newline** will be completely ignored!
...
So far, you've seen _previews_ of Markdown rendering,
but haven't produced a rendered output file like a HTML or PDF.
In fact, this is rarely needed in practice, because:

- Markdown source is so well readable, and VS Code applies quite some formatting to it
- Markdown files you intend to share will/should end up on GitHub,
  which will render them for you (_week 4_)
