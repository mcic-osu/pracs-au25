...
::: {.callout-warning}
#### In case the printed directory is not your username
...
{{< fa user-edit >}} _Does `echo` seem useless, or can you think of ways in which it could be useful?_
_We'll get back to this later._
...
- Are not preceded by `-` and a letter (or `--` with a keyword)
...
- `$HOME`, which contains the path to your Home dir
