---
title: "Working with files in the Unix shell: Part I"
...
<details><summary>_Click here if you need the instructions_</summary>
...
1. Create a dir for this week (e.g. `mkdir week03` in the shell)
1. Click <i class="fa fa-bars"></i> => `File` => `New File`.
2. Save the file (e.g. <kbd>Ctrl/⌘</kbd>+<kbd>S</kbd>) inside the `week03` dir
   in your personal dir as e.g. `session1-shellfiles.md`.

<hr style="height:1pt; visibility:hidden;" />

### Further VS Code setup {-}
...
we already learned a command that also falls in this category -- to recap:
