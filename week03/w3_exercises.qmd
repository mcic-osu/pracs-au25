...
4. `zcat` is a command that is essentially identical to `cat`,
   ...
   Pipe the output of `zcat` to another command to print the file's first 15 lines.
...
<details><summary>**1.** Create a dir `week03/ex4` within `/fs/ess/PAS2880/users/$USER`, and navigate there</summary>
