...
- View the contents of text files in various ways ([next lecture](./w3b_shellfiles.qmd))
- Search within, manipulate, and extract information from text files ([next lecture](./w3b_shellfiles.qmd))
