...
subtitle: "Week 3 -- lecture I"
pagetitle: "Shell files I"
date: 2025-09-05
author:
...
Like before, I recommend that you create and open a Markdown file to keep
...
2. Save the file inside `/fs/ess/PAS2880/users/$USER/week03`,
   e.g. as `lecture1.md` (use a `.md` extension).
...
SHOW DOWNLOAD RIGHT-CLICK OPTION?
