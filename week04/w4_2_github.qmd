...
subtitle: "Week 4 - Version Control - Part II"
...
- Collaborate with others^[
  ...
  see the [bonus material](w4_3_advanced-git.qmd#collaboration-with-git-multi-user-remote-workflows) for this.].
...
- To & from the **currently active repository *"branch"*** (default: `main`)^[
  To learn more about branches, see the [Git bonus material](w4_3_advanced-git.qmd).].
...
The [version control bonus page](w4_3_advanced-git.qmd##collaboration-with-git-multi-user-remote-workflows) goes into collaboration with Git
