...
- Collaborate with others^[
  ...
  see the [bonus material](../ref/adv-git.qmd#collaboration-with-git-multi-user-remote-workflows) for this.].
...
- To & from the **currently active repository *"branch"*** (default: `main`)^[
  To learn more about branches, see the [Git bonus material](../ref/adv-git.qmd).].
...
The [version control bonus page](../ref/adv-git.qmd##collaboration-with-git-multi-user-remote-workflows) goes into collaboration with Git
