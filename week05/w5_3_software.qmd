...
other-links:
  ...
  - text: "Optional reading: Conda"
    icon: book
    href: ../ref/conda.html
  - text: "Optional reading: SSH"
    icon: book
    href: ../ref/ssh.html
  - text: "Optional reading: More file transfer"
    icon: book
...
However, there is a wrinkle --- while FastQC is installed at OSC^[
For a full list of installed software at OSC:
