...
- Tuesday -- [Shell scripts intro](./w5_1_scripts.qmd)
- Tuesday/Thursday -- [An RNA-Seq dataset](./w5_1_scripts.qmd)
- Thursday -- [Running CLI tools with shell scripts](./w5_3_cli-tools.qmd).
