...
pagetitle: "PRACS24: software at OSC"
...
As you saw last week for FastQC, we do need to "load" such programs before we can use them^[
And with Git we saw another kind of behavior, where the automatically available version is very old,
but we can load a more recent version.]. We will talk more about this process today.
