...
However, we've been running shell commands in a manner we may call "interactive",
...
As such, the `prinline.sh` file with a single `echo` command
...
these placeholder variables are not automatically _used_.
