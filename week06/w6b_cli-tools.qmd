...
The approach of running the script for one FASTQ file at a time means that
your script needs to **accept a FASTQ file name as an argument**.
Additionally, you will have an argument for the output dir too,
...
And you could run such a script as follows for a single FASTQ file:
...
Next week, we'll discuss how you can organize this for larger projects.
:::
