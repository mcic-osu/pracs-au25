...
when you **submit a separate batch job for each file or sample**^[
...
Additionally, you will use an argument for the output dir too,
...
It is often useful to have your shell scripts "report" or "log" what is going on.
For instance:
...
_detailed records about what you did!_

Let's try adding some logging information to the FastQC script:
...
but you need to keep a record of your analysis steps,
which you will save in a Markdown file.
For small projects, a simple "protocol" could be added to your main `README.md`.
Let's practice with that by creating and writing a README for the current analysis:
...
that "collection" is just a short list of numbers (`1`, `2`, and `3`):
...
and can allow you to easily run a script many times.
...
you have not yet learned how to run it simultaneously. 
Next week, you'll learn about submitting scripts like this as batch jobs,
so they can be run simultaneously and save you a lot of time.
...
Next week, we'll move on to submitting shell scripts as batch jobs at OSC.
