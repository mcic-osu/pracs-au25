...
- Copy two scripts from last week that you'll use again:
  
  ```bash
  cp /fs/ess/PAS2880/users/$USER/week06/scripts/printname.sh scripts/
  cp /fs/ess/PAS2880/users/$USER/week06/scripts/fastqc.sh scripts/
  ```
