...
it will continue to run even if you, for example,
log off from OSC and shut down your computer.
...
But first, recall from last week that you can simply run a Bash script as follows:
...
But, depending on the details of the script itself,
...
<details><summary>Any idea why we may not want batch job output printed to screen, even if it were possible? _(Click for the answer)_</summary>
...
You can use both of the following strategies to help prevent this:
