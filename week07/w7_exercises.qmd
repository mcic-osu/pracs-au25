...
`/fs/ess/PAS2880/users/$USER/garrigos-data/fastq`.
...
[the last exercise on the Slurm batch job page](w7a_slurm1.qmd#exercise-submit-your-fastqc-script-as-a-batch-job):
...
As a starting point, take your TrimGalore shell script from TBA,
