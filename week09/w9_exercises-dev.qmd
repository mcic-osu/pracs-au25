...
- Copy the primary scripts:
  ...
  ```bash
  cp -v /fs/ess/PAS2880/share/exercises/week6/scripts/* scripts/
  ```
  ```bash-out
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/fastqc.sh’ -> ‘scripts/fastqc.sh’
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/featurecounts.sh’ -> ‘scripts/featurecounts.sh’
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/multiqc.sh’ -> ‘scripts/multiqc.sh’
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/star_align.sh’ -> ‘scripts/star_align.sh’
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/star_index.sh’ -> ‘scripts/star_index.sh’
  ‘/fs/ess/PAS2880/share/exercises/week6/scripts/trimgalore.sh’ -> ‘scripts/trimgalore.sh’
  ```
...
featureCounts -v
echo "# Successfully finished script featurecounts.sh"
date
```
</details>
