...
two kinds of more complicated AI have been developed and applied more recently:

- **Deep learning / Neural nets** have become commonly used in the past 10+ years
  - DeepMind's AlphaFold -- 3D protein structure prediction from sequence
  - DeepVariant -- variant calling from sequencing data
  - Applications in image analysis, e.g. microscopy or histology images

  ::: {.callout-tip appearance="simple"}
  Also numerous applications outside of bioinformatics.
  Example in plant pathology -- @zhang2022:
...
create new content, such as text, images, music, or code.
This has become extremely prominent since ChatGPT’s launch in 2022.
...
those kind of purely "sequential" models have been around for a long time
and have long been present in Google when you type in your search phrase.
LLMs use more complex architectures, such as **"transformers"**,
...
is that they can still fail spectacularly on "kindergarten-level" tasks:
...
- You are able to use (more advanced models) without usage limits
...
Within IDEs, there can be two main modes of interaction, as we'll see:
...
- Less need to copy-paste code snippets
...
- _"Explain the most important options to TrimGalore"_
  ...
  ![](../img/letter-count-unconventional.png){fig-align="center" width="80%" fig-alt="A screenshot of a ChatGPT response about TrimGalore" .lightbox}
    ...
    ![](../img/letter-count-blueberry.png){fig-align="center" width="80%" fig-alt="A screenshot of a ChatGPT response about TrimGalore" .lightbox}
  </details>
...
- _"How many n's are in the word unconventional?"_ and
  ...
  ![](../img/ms-copilot_trimgalore-response2.png){fig-align="center" width="80%" fig-alt="A screenshot of a ChatGPT response about TrimGalore" .lightbox}
  </details>
...
- Or:
  - Context - Who you are, what you’re working on, what the AI needs to know
  - Task - What specifically you want the AI to do
  - Format - How you want the output structured
  - Constraints - Any limitations, requirements, or things to avoid
  - Examples - Sample inputs/outputs if helpful

- "Prompt enhancers":
  - "Explain with examples" or "explain as if I'm a high school student"
  - "Please ask me clarifying questions"
  - "Tell me when you’re unsure about something"
  - Verify: "Show me the specific quotes from the papers that support each of these conclusions"

- Be specific and detailed, e.g. about formats and programs
- For bigger problems, break it down into smaller ones

### Pitfalls

- AI hallucinations
  - It doesn't run code it suggests and may even misstate the expected output
  - May come up with functions/commands or columns that don't exist
