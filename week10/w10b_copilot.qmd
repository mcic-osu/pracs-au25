...
- Use all extensions
- Reap the benefits of no longer operating within a browser tab
...
In-line chat with <kbd>⌘</kbd>+<kbd>I</kbd>.
...
### Advanced chat usage with "slash commands" and more

As the chat window shows in ghost text, you can use keyboard shortcuts to
activate certain options:
