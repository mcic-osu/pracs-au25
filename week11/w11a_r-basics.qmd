...
You can use R with a "console" that runs directly inside the terminal.
At OSC, you can R inside terminal after loading the R module.
However, we will use R with a fancy editor (or "IDE", Integrated Development Environment)
called [RStudio](https://www.rstudio.com/products/rstudio/download/#download),
which makes working with it much more pleasant!
You can also download **RStudio** to your local computer.
...
## R basics
R can be used for many tasks: data manipulation, data visualization, 
statistical analysis, machine learning and many more. Here, we will start by learning to use 
R as a calculator.
