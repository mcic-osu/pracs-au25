...
This will make R restart, which is by design because to reset the workinspace by removing objects, variables, packages from the previous session, to avoid conflicts, to set the working directory.
***[TBA expand on this]***
