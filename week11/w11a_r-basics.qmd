...
- TBA: Add a couple of mini-exercises
...
- **Left:** the default and most useful tab in this panel is your R "Console",
...
***[TBA - Switch below to screenshot from OSC, and annotate in Powerpoint]***

![](../img/R_studio_panes){width="100%" fig-align="center"}
...
***[TBA - Talk about leaving spaces between numbers / space-sensitivity]***
...
In R, you can choose to name the **arguments** in a function or just use their **position**.
When you name an argument, the order does not matter, R will know exactly which value goes
...
***[TBA - explain naming versus not-naming args - e.g.:]***
...
***[TBA - Explain why RStudio Projects are useful]***
...
![REPLACE THIS SCREENSHOT TO ONE WITH THE CORRECT PATH](../img/rstudio_proj_path.png){fig-align="center" width="35%"}
...
This will make R restart, which is by design because... ***[TBA expand on this]***
