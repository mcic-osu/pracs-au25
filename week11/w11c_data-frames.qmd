...
1. At <https://ondemand.osc.edu>,
   start an RStudio session like in the previous lecture  [Starting an RStudio Server session at OSC](../week11/w11a_r-basics.html#Working-directory-and-RStudio-Projects).
2. Switch to your `week11` RStudio Project [Working directory and RStudio Projects](../week11/w11a_r-basics.html#Working-directory-and-RStudio-Projects).
3. Open a new R Script and save it as week_11_script.R in your `week11` folder [R scripts](../week11/w11a_r-basics.html#R-scripts).
