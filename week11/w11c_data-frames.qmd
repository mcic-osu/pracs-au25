...
The matrix data structure in R is similar to a dataframe:
...
**TBA EXPLAIN ROWNAMES AND HOW THESE CAN BE USED**
_(But also mention that with dataframes, rownames are not commonly used for IDs.)_
...
**TBA -- I'd suggest to do an exercise with `iris` instead**
